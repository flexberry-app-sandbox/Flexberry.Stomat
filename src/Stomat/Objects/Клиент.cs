...
namespace IIS.Stomat
{
    ...
    public class Клиент : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Stomat.DetailArrayOfДокументы fДокументы;
        ...
        public virtual IIS.Stomat.DetailArrayOfДокументы Документы
        {
            get
            {
                ...
                {
                    this.fДокументы = new IIS.Stomat.DetailArrayOfДокументы(this);
                }
                IIS.Stomat.DetailArrayOfДокументы result = this.fДокументы;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КлиентE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентE", typeof(IIS.Stomat.Клиент));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КлиентL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КлиентL", typeof(IIS.Stomat.Клиент));
                }
            }
        }
    }
