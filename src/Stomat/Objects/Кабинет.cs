    ...
    public class Кабинет : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КабинетE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КабинетE", typeof(IIS.Stomat.Кабинет));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КабинетL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КабинетL", typeof(IIS.Stomat.Кабинет));
                }
            }
        }
    }
