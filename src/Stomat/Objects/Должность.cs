    ...
    public class Должность : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДолжностьE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДолжностьE", typeof(IIS.Stomat.Должность));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДолжностьL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДолжностьL", typeof(IIS.Stomat.Должность));
                }
            }
        }
    }
