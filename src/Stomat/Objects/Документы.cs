...
namespace IIS.Stomat
{
    ...
    public class Документы : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Stomat.Клиент.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДокументыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокументыE", typeof(IIS.Stomat.Документы));
                }
            }
        }
    }
    ...
    public class DetailArrayOfДокументы : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Stomat.DetailArrayOfДокументы members)

        // *** End programmer edit section *** (IIS.Stomat.DetailArrayOfДокументы members)
        ...
        /// </summary>
        public DetailArrayOfДокументы(IIS.Stomat.Клиент fКлиент) : 
                base(typeof(Документы), ((ICSSoft.STORMNET.DataObject)(fКлиент)))
        {
        }
        
        public IIS.Stomat.Документы this[int index]
        {
            get
            {
                return ((IIS.Stomat.Документы)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Stomat.Документы dataobject)
        {
